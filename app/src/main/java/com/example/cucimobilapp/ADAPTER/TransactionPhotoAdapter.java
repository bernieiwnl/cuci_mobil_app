...
public class TransactionPhotoAdapter extends RecyclerView.Adapter<TransactionPhotoAdapter.MyViewHolder>  {

    public List<Bitmap> fileImageList;
    public Context c;

    public TransactionPhotoAdapter(List<Bitmap> fileImageList, Context c){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new TransactionPhotoAdapter.MyViewHolder(LayoutInflater.from(c).inflate(R.layout.custom_list_transaction_photo , parent , false));
    }
