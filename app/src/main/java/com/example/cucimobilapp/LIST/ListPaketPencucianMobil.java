...
public class ListPaketPencucianMobil extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_paket_pencucian_mobil);
        ...
        firebaseFirestore.collection("package").whereEqualTo("package_vehicle_type", "Mobil").addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                ...
                if(!queryDocumentSnapshots.isEmpty()){
                    ...
                    packageAdapter = new PackageAdapter(ListPaketPencucianMobil.this, Pakets);
    ...
    private void filter(String text) {
        ...
        for (Paket c : Pakets) {
            ...
            packageAdapter = new PackageAdapter(ListPaketPencucianMobil.this, data);
            recyclerView_paketPencucianMobil.setAdapter(packageAdapter);
        }
    }
