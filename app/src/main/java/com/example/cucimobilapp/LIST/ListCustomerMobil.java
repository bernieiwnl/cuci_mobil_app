...
public class ListCustomerMobil extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_customer_mobil);
        ...
        firebaseFirestore.collection("customer").whereEqualTo("customer_vehicle_type", "Mobil").addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                ...
                if(!queryDocumentSnapshots.isEmpty()){
                    ...
                    customerAdapter = new CustomerAdapter(getApplicationContext(), Customers);
