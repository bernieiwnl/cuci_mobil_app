...
public class MasterListCustomerMobil extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText textInputEditText_searchMobil;
    private ImageView imageView_back;

    static MasterListCustomerMobil masterListCustomerMobil;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_master_list_customer_mobil);

        recyclerView_customerMobil = (RecyclerView) findViewById(R.id.recycler_customerMobil);
        textInputEditText_searchMobil = (EditText) findViewById(R.id.editText_searchBar);
        ...
        firebaseFirestore.collection("customer").whereEqualTo("customer_vehicle_type", "Mobil").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
        ...
        textInputEditText_searchMobil.addTextChangedListener(new TextWatcher() {
            @Override
    ...
    public static MasterListCustomerMobil getInstance(){
        return masterListCustomerMobil;
    }
