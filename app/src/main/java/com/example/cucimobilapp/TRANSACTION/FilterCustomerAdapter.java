...
public class FilterCustomerAdapter extends RecyclerView.Adapter<FilterCustomerAdapter.MyViewHolder> {

    private ArrayList<Customer> Customers;
    private Context context;

    public FilterCustomerAdapter(Context c, ArrayList<Customer> Customers){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new FilterCustomerAdapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.custom_list_customer , parent , false));
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.button_pilih.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent();
                i.putExtra("nama_cus", Customers.get(position).getCustomer_name());
